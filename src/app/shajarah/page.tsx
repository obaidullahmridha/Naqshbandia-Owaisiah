          ...
          <CardContent className="space-y-6 max-w-none">
            {post ? (
              ...
              <p className="text-lg text-muted-foreground">
                কোনো তথ্য পাওয়া যায়নি। অনুগ্রহ করে আপনার ব্লগস্পট সাইটে "Tree" ট্যাগ দিয়ে একটি পোস্ট তৈরি করুন।
              </p>
            )}
          </CardContent>
        </Card>
